...
type User struct {
	UserID      uuid.UUID  `json:"user_id" db:"user_id" gorm:"primaryKey" redis:"user_id" validate:"omitempty"`
	...
	Email       string     `json:"email,omitempty" db:"email" redis:"email" validate:"required,omitempty,lte=60,email"`
